...
class QuantumCircuitEnv2Qubits:
    ...
    def action2matrix(self, action):
        ...
        if   action == 'X0': return (tensor(sigmax(), qeye(2)), 0.60)
        elif action == 'Y0': return (tensor(sigmay(), qeye(2)), 0.60)
        elif action == 'Z0': return (tensor(sigmaz(), qeye(2)), 0.60)
        elif action == 'H0': return (tensor(snot(N=1), qeye(2))  , 0.60)
        elif action == 'X1': return (tensor(qeye(2), sigmax()), 1.72)
        elif action == 'Y1': return (tensor(qeye(2), sigmay()), 1.72)
        elif action == 'Z1': return (tensor(qeye(2), sigmaz()), 1.72)
        elif action == 'H1': return (tensor(qeye(2), snot(N=1)), 1.72)
        elif action == 'CNOT10': return (cnot(N=2, control=1, target=0), 2.35)
...
class QuantumCircuitEnv3Qubits:
    ...
    def action2matrix(self, action):
        # Matrices representation of the possible gates
        if   action == 'X0': return (tensor(sigmax(), qeye(2), qeye(2)), 0.60)
        elif action == 'Y0': return (tensor(sigmay(), qeye(2), qeye(2)), 0.60)
        elif action == 'Z0': return (tensor(sigmaz(), qeye(2), qeye(2)), 0.60)
        elif action == 'H0': return (tensor(snot(N=1), qeye(2), qeye(2))  , 0.60)
        elif action == 'X1': return (tensor(qeye(2), sigmax(), qeye(2)), 1.72)
        elif action == 'Y1': return (tensor(qeye(2), sigmay(), qeye(2)), 1.72)
        elif action == 'Z1': return (tensor(qeye(2), sigmaz(), qeye(2)), 1.72)
        elif action == 'H1': return (tensor(qeye(2), snot(N=1), qeye(2))  , 1.72)
        elif action == 'X2': return (tensor(qeye(2), qeye(2), sigmax()), 1.97)
        elif action == 'Y2': return (tensor(qeye(2), qeye(2), sigmay()), 1.97)
        elif action == 'Z2': return (tensor(qeye(2), qeye(2), sigmaz()), 1.97)
        elif action == 'H2': return (tensor(qeye(2), qeye(2), snot(N=1))  , 1.97)
        elif action == 'CNOT10': return (cnot(N=3, control=1, target=0), 2.35)
        elif action == 'CNOT20': return (cnot(N=3, control=2, target=0), 3.73)
        elif action == 'CNOT21': return (cnot(N=3, control=2, target=1), 5.69)
...
class QuantumCircuitEnv4Qubits:
    ...
    def action2matrix(self, action):
        # Matrices representation of the possible gates
        if   action == 'X0': return (tensor(sigmax(), qeye(2), qeye(2), qeye(2)), 0.60)
        elif action == 'Y0': return (tensor(sigmay(), qeye(2), qeye(2), qeye(2)), 0.60)
        elif action == 'Z0': return (tensor(sigmaz(), qeye(2), qeye(2), qeye(2)), 0.60)
        elif action == 'H0': return (tensor(snot(N=1), qeye(2), qeye(2), qeye(2))  , 0.60)
        elif action == 'X1': return (tensor(qeye(2), sigmax(), qeye(2), qeye(2)), 1.72)
        elif action == 'Y1': return (tensor(qeye(2), sigmay(), qeye(2), qeye(2)), 1.72)
        elif action == 'Z1': return (tensor(qeye(2), sigmaz(), qeye(2), qeye(2)), 1.72)
        elif action == 'H1': return (tensor(qeye(2), snot(N=1), qeye(2), qeye(2))  , 1.72)
        elif action == 'X2': return (tensor(qeye(2), qeye(2), sigmax(), qeye(2)), 1.97)
        elif action == 'Y2': return (tensor(qeye(2), qeye(2), sigmay(), qeye(2)), 1.97)
        elif action == 'Z2': return (tensor(qeye(2), qeye(2), sigmaz(), qeye(2)), 1.97)
        elif action == 'H2': return (tensor(qeye(2), qeye(2), snot(N=1), qeye(2))  , 1.97)
        elif action == 'X3': return (tensor(qeye(2), qeye(2), qeye(2), sigmax()), 1.97)
        elif action == 'Y3': return (tensor(qeye(2), qeye(2), qeye(2), sigmay()), 1.97)
        elif action == 'Z3': return (tensor(qeye(2), qeye(2), qeye(2), sigmaz()), 1.97)
        elif action == 'H3': return (tensor(qeye(2), qeye(2), qeye(2), snot(N=1))  , 1.97)
        elif action == 'CNOT10': return (cnot(N=4, control=1, target=0), 2.35)
        elif action == 'CNOT20': return (cnot(N=4, control=2, target=0), 3.73)
        elif action == 'CNOT21': return (cnot(N=4, control=2, target=1), 5.69)
        elif action == 'CNOT32': return (cnot(N=4, control=3, target=2), 4.505)
...
class QuantumCircuitEnv5Qubits:
    ...
    def action2matrix(self, action):
        # Matrices representation of the possible gates
        if   action == 'X0': return (tensor(sigmax(), qeye(2), qeye(2), qeye(2), qeye(2)), 0.60)
        elif action == 'Y0': return (tensor(sigmay(), qeye(2), qeye(2), qeye(2), qeye(2)), 0.60)
        elif action == 'Z0': return (tensor(sigmaz(), qeye(2), qeye(2), qeye(2), qeye(2)), 0.60)
        elif action == 'H0': return (tensor(snot(N=1), qeye(2), qeye(2), qeye(2), qeye(2))  , 0.60)
        elif action == 'X1': return (tensor(qeye(2), sigmax(), qeye(2), qeye(2), qeye(2)), 1.72)
        elif action == 'Y1': return (tensor(qeye(2), sigmay(), qeye(2), qeye(2), qeye(2)), 1.72)
        elif action == 'Z1': return (tensor(qeye(2), sigmaz(), qeye(2), qeye(2), qeye(2)), 1.72)
        elif action == 'H1': return (tensor(qeye(2), snot(N=1), qeye(2), qeye(2), qeye(2))  , 1.72)
        elif action == 'X2': return (tensor(qeye(2), qeye(2), sigmax(), qeye(2), qeye(2)), 1.97)
        elif action == 'Y2': return (tensor(qeye(2), qeye(2), sigmay(), qeye(2), qeye(2)), 1.97)
        elif action == 'Z2': return (tensor(qeye(2), qeye(2), sigmaz(), qeye(2), qeye(2)), 1.97)
        elif action == 'H2': return (tensor(qeye(2), qeye(2), snot(N=1), qeye(2), qeye(2))  , 1.97)
        elif action == 'X3': return (tensor(qeye(2), qeye(2), qeye(2), sigmax(), qeye(2)), 1.97)
        elif action == 'Y3': return (tensor(qeye(2), qeye(2), qeye(2), sigmay(), qeye(2)), 1.97)
        elif action == 'Z3': return (tensor(qeye(2), qeye(2), qeye(2), sigmaz(), qeye(2)), 1.97)
        elif action == 'H3': return (tensor(qeye(2), qeye(2), qeye(2), snot(N=1), qeye(2))  , 1.97)
        elif action == 'X4': return (tensor(qeye(2), qeye(2), qeye(2), qeye(2), sigmax()), 1.97)
        elif action == 'Y4': return (tensor(qeye(2), qeye(2), qeye(2), qeye(2), sigmay()), 1.97)
        elif action == 'Z4': return (tensor(qeye(2), qeye(2), qeye(2), qeye(2), sigmaz()), 1.97)
        elif action == 'H4': return (tensor(qeye(2), qeye(2), qeye(2), qeye(2), snot(N=1))  , 1.97)
        elif action == 'CNOT10': return (cnot(N=5, control=1, target=0), 2.35)
        elif action == 'CNOT20': return (cnot(N=5, control=2, target=0), 3.73)
        elif action == 'CNOT21': return (cnot(N=5, control=2, target=1), 5.69)
        elif action == 'CNOT32': return (cnot(N=5, control=3, target=2), 4.505)
        elif action == 'CNOT34': return (cnot(N=5, control=3, target=4), 4.505)
        elif action == 'CNOT42': return (cnot(N=5, control=4, target=2), 6.968)
